...
#define SENDER_SERVER_PORT 5208 
#define SENDERBUF_SIZE 1024
#define SENDERMAX_CLNT 256   

int getConfigFieldIntValue2(const char* strFiledName, const char *config_file_name = "vrpn.cfg");
