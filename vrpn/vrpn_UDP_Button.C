#include <math.h>
#include <string.h>
#include "vrpn_UDP_Button.h"
#ifdef	_WIN32
#include <windows.h>
#pragma comment (lib, "user32.lib")
#endif

vrpn_UDP_Button::vrpn_UDP_Button (const char * name, vrpn_Connection * c) :
    vrpn_Button_Filter(name, c)
{
    int i;
    // Set the parameters in the parent classes
    num_buttons = getConfigFieldIntValue("vrpn_UDP_Button");
	//num_buttons = 256;   
	...
	readFlag = false;
#ifndef _WIN32
    fprintf(stderr,"vrpn_UDP_Button:: Not implement on this architecture\n");
#endif
}

vrpn_UDP_Button::~vrpn_UDP_Button()
{
}
   
int vrpn_UDP_Button::get_report(void)
{
    struct timeval time;
    ...
    if (GetKeyboardState(virtual_keys) == 0) {
      fprintf(stderr,"vrpn_UDP_Button::get_report(): Could not read keyboard state\n");
      return 0;
    }*/
