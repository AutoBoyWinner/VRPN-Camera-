...
vrpn_UDP_Analog::vrpn_UDP_Analog( const char* name, vrpn_Connection * cxn ) :
	...
	vrpn_Button_Filter( name, cxn )
{
	...
	vrpn_Analog::num_channel = getConfigFieldIntValue("vrpn_UDP_Analog");
...
#else
    fprintf(stderr,"vrpn_UDP_Analog::vrpn_UDP_Analog() Not implement on this architecture\n");
#endif
}

///////////////////////////////////////////////////////////////////////////

vrpn_UDP_Analog::~vrpn_UDP_Analog()
{
#if defined(linux) && defined(VRPN_USE_GPM_MOUSE)
    Gpm_Close();
#endif
...
int vrpn_UDP_Analog::get_report()
{
#if defined(linux) && defined(VRPN_USE_GPM_MOUSE)
    fd_set readset;
...
/*    POINT curPos;
	...
	vrpn_Analog::channel[2] = (vrpn_float64)(curPos.x - GetSystemMetrics(SM_XVIRTUALSCREEN)) / GetSystemMetrics(SM_CXVIRTUALSCREEN);
*/
...
void vrpn_UDP_Analog::report_changes( vrpn_uint32 class_of_service )
{
...
void vrpn_UDP_Analog::report( vrpn_uint32 class_of_service )
{
    vrpn_Analog::timestamp = timestamp;
    vrpn_Button_Filter::timestamp = timestamp;
...
vrpn_Button_SerialMouse::vrpn_Button_SerialMouse(const char *name,vrpn_Connection *c,
						 const char *port, int baud, vrpn_UDP_AnalogTYPE type)
...
// mouse and a MouseSystems mouse, see
