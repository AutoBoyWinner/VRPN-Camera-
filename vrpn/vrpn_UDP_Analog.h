#ifndef vrpn_UDP_Analog_H
#define vrpn_UDP_Analog_H
...
///////////////////////////////////////////////////////////////////////////
// vrpn_UDP_Analog is a VRPN server class to publish events from the PC's mouse.
// It provides a 2-channel vrpn_Analog for X & Y mouse motion, and a
// 3-channel vrpn_Button for the mouse buttons.
//
// vrpn_UDP_Analog makes it easy to use the diverse array of commodity input
...
// 
// vrpn_UDP_Analog must be run on a Linux console, not an xterm.  Rationale:
...
class VRPN_API vrpn_UDP_Analog :
	public vrpn_Analog,
	public vrpn_Button_Filter
{
public:
    vrpn_UDP_Analog( const char* name, vrpn_Connection* cxn );
    virtual ~vrpn_UDP_Analog();
...
private:  // disable unwanted default methods
    vrpn_UDP_Analog();
    vrpn_UDP_Analog(const vrpn_UDP_Analog&);
    const vrpn_UDP_Analog& operator=(const vrpn_UDP_Analog&);
};
...
enum vrpn_UDP_AnalogTYPE {MOUSESYSTEMS, THREEBUTTON_EMULATION, MAX_MOUSE_TYPES};
