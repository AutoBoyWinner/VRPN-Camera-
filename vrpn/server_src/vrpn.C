...
int tcpServerPortforSender = 11111;
...
void __cdecl CreateTCPServer(void* vrpnServer ) 
{

	TCPServer server(serverIP, tcpServerPortforSender);

	if (server.initWinsock()) {

		server.run((void*)vrpnServer);
...
int main (int argc, char * argv[])
{
  ...
  int	realparams = 0;
  int	i;
  int	port = getConfigFieldIntValue("vrpn_UDP_PORT");//1211;//vrpn_DEFAULT_LISTEN_PORT_NO;
#ifdef	_WIN32
  ...
  ///// creating server socket for Send Device//////////////
  //////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////
	tcpServerPortforSender = getConfigFieldIntValue("vrpn_TCP_PORT");
	_beginthread(CreateTCPServer, NULL, (void*)generic_server);
////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////
