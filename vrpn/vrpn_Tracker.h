...
class VRPN_API vrpn_Tracker : public vrpn_BaseClass {
  ...
  public:
   ...
   vrpn_float64 last_pos[3], last_d_quat[4];	// last pose, (x,y,z), (qx,qy,qz,qw)
...
class VRPN_API vrpn_UDP_Tracker: public vrpn_Tracker {
  public:
   vrpn_UDP_Tracker (const char * name, vrpn_Connection * c,
